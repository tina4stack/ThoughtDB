...
@params(["auth_key", "collection_name"])
@example({"name": "My Document", "document": "Data in the document can be base64 for pdf", "url": "optional url to text or pdf", "documentType": "text/pdf/word/excel", "metadata": ["tag1", "tag2", "tag3"]})
@tags("Documents")
@secure()
